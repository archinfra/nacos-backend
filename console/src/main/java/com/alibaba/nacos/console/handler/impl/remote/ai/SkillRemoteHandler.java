...
public class SkillRemoteHandler implements SkillHandler {
    ...
    @Override
    public void updateSkillMetadata(SkillMetadataUpdateForm form) throws NacosException {
        // Remote maintainer SDK currently exposes bizTags update only. Metadata ext is fully supported by inner mode.
        clientHolder.getAiMaintainerService().skill()
            .updateBizTags(form.getNamespaceId(), form.getSkillName(),
                com.alibaba.nacos.ai.utils.SkillMetadataUtils.buildBizTags(form.toSkillMetadata()));
    }
