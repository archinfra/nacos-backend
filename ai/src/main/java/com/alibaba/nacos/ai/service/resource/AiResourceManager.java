...
public class AiResourceManager {
    ...
    /**
     * CAS-update the ext field of a resource meta row.
     */
    public void updateExtCas(String namespaceId, AiResource meta, String ext)
            throws NacosException {
        if (meta == null || meta.getMetaVersion() == null) {
            throw new NacosApiException(NacosException.SERVER_ERROR, ErrorCode.SERVER_ERROR,
                    "Meta version missing");
    ...
    public void insertBootstrapMeta(String namespaceId, String name, String type,
        ...
        insertBootstrapMeta(namespaceId, name, type, description, bizTags, null, owner, from, version, storageJson);
    }

    public void insertBootstrapMeta(String namespaceId, String name, String type,
            String description,
            String bizTags, String ext, String owner, String from, String version, String storageJson) {
    ...
    public void initOrUpdateMetaForDraft(String namespaceId, String name, String type,
            ...
            throws NacosException {
        initOrUpdateMetaForDraft(namespaceId, name, type, description, bizTags, null, version, existedMeta, isNew);
    }

    public void initOrUpdateMetaForDraft(String namespaceId, String name, String type,
            String description,
            String bizTags, String ext, String version, AiResource existedMeta, boolean isNew)
            throws NacosException {
        if (isNew) {
            ...
            boolean syncBizTags = StringUtils.isNotBlank(bizTags);
            boolean syncExt = StringUtils.isNotBlank(ext);
